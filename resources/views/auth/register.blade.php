                        ...
                        <div class="content">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <input id="name" type="text" name="name" required data-msg="Please enter your name" class="input-material" placeholder=" " :value="old('name')" autofocus>
                                    <label for="name" class="label-material">Name</label>
                                </div>
                                <div class="form-group">
                                    <input id="email" type="email" name="email" required data-msg="Please enter your email" class="input-material" placeholder=" " :value="old('email')">
                                ...
                                <div class="form-group">
                                    <input id="password_confirmation" type="password" name="password_confirmation" required data-msg="Please confirm your password" class="input-material" placeholder=" ">
